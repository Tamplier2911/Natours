...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJ0ZW0yOTExIiwiYSI6ImNrM2VrcXNtNzA5YjMzbm16cWN3bjg0MjUifQ.nAGRcWm4Pe8rEiT6GvQNAA';
  ...
  var bounds = new mapboxgl.LngLatBounds(); // for each location creating a marker

  locations.forEach(function (location) {
    // create html element
    var marker = document.createElement('div'); // add class

    marker.className = 'marker'; // create instance of Marker
    ...
    .setLngLat(location.coordinates) // method requires an element, isntance of Map which will use this bounds
    .addTo(map); // create instance of Popup

    new mapboxgl.Popup({
      anchor: 'left',
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // extending map bounds to include current location each
...
var arr = url.split('/'); // let protocol = arr[0];
// let host = arr[2];

var address = arr[0] + '//' + arr[2];
...
exports.passwordReset = exports.passwordForgot = exports.logout = exports.login = void 0;
      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'POST',
            url: "".concat(_address.address, "/api/v1/users/login"),
            data: {
              email: email,
              password: password
            }
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alerts.showAlert)('success', 'Logged in successfully!'); //   location.assign('/');
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'GET',
            url: "".concat(_address.address, "/api/v1/users/logout")
          }));
...
var passwordForgot = function passwordForgot(email) {
  var res;
  return regeneratorRuntime.async(function passwordForgot$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'POST',
            url: "".concat(_address.address, "/api/v1/users/forgotPassword"),
            data: {
              email: email
            }
          }));
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Email was sent to ".concat(email));
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
var passwordReset = function passwordReset(token, password, passwordConfirm) {
  var res;
  return regeneratorRuntime.async(function passwordReset$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
            url: "".concat(_address.address, "/api/v1/users/resetPassword/").concat(token),
            data: {
              password: password,
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your password is successfully reseted!');
        ...
        case 8:
          ...
          console.log(_context4.t0); // showAlert('error', 'Please, make sure that you spell token correctly!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./address":"address.js"}],"signup.js":[function(require,module,exports) {
"use strict";
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'POST',
            url: "".concat(_address.address, "/api/v1/users/signup"),
            data: {
              name: name,
              email: email,
              password: password,
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your account was successfully created!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./address":"address.js"}],"update.js":[function(require,module,exports) {
"use strict";
...
// alert
// address
var updateData = function updateData(form) {
  var res;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
            url: "".concat(_address.address, "/api/v1/users/updateMe"),
            data: form
          }));
...
var updatePassword = function updatePassword(password, newPassword, passwordConfirm) {
  var res;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
            url: "".concat(_address.address, "/api/v1/users/updateMyPassword"),
            data: {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./address":"address.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var stripe = Stripe('pk_test_KaRPQReBBNZ8yMVXgK6loII400IX5k1kCa');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'GET',
            url: "".concat(_address.address, "/api/v1/booking/checkout-session/").concat(tourId)
          }));
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./address":"address.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
// update user data
// checkout page
console.log('Parcel bundler.'); // DOM ELEMENTS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// get map element
...
var passwordForgotForm = document.querySelector('#passwordForgotForm');
var passwordResetForm = document.querySelector('#passwordResetForm'); // get book tour button

var bookTourButton = document.querySelector('#bookTour'); // get logout button
...
if (updateUserDataForm) {
  updateUserDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // selecting field values

    var name = document.querySelector('#nameUpdate').value;
    var email = document.querySelector('#emailUpdate').value;
    var photo = document.querySelector('#photoUpdate').files[0]; // specifying enctype multipart/form-data programmatically
...
if (updateUserPasswordForm) {
  updateUserPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = document.querySelector('#passwordCurrent').value;
    var newPassword = document.querySelector('#passwordNew').value;
    var passwordConfirm = document.querySelector('#passwordConfirm').value;
    document.querySelector('#savePassword').textContent = 'Updating...';
    (0, _update.updatePassword)(password, newPassword, passwordConfirm); // clear password fields after submition
...
if (passwordForgotForm) {
  passwordForgotForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.querySelector('#passwordForgotEmail').value;
    (0, _login.passwordForgot)(email);
  });
}
...
if (passwordResetForm) {
  passwordResetForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var token = document.querySelector('#passwordResetToken').value;
    var password = document.querySelector('#newPassword').value;
    var passwordConfirm = document.querySelector('#newPasswordConfirm').value;
    (0, _login.passwordReset)(token, password, passwordConfirm);
  });
}
...
var menuCheckbox = document.querySelector('.header__check');
...
window.onresize = function (e) {
  if (e.target.innerWidth > 690 && navUser.style.display === 'grid' || e.target.innerWidth > 690 && navUser.style.display === 'none') {
